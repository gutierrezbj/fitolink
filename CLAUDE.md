...
| Contexto normativo recibido del chat WhatsApp técnico (referencia interna · NO copy comercial). Marco legal **3 BLOQUES ACUMULATIVOS** para tratamientos fitosanitarios con dron en España: **Bloque 1 · Seguridad aérea** AESA/EASA con PDRA-S01[F] (desde mayo 2024 · drones hasta 3m) o SORA + DRI activo + operador UAS registrado + manual operaciones + seguro RC. **Bloque 2 · ITEAF** (RD 1702/2011) · dron es equipo de aplicación, censar en MAPA (ROMA generalmente, REGANIP en Extremadura) + ISO 16122-5 (aún en desarrollo) · primera inspección a los 5 años desde factura compra, luego cada 3 años · NO aplica si solo abono o OCB. **Bloque 3 · Fitosanitario** (RD 1311/2012) · art. 27 PROHÍBE aplicación aérea con carácter general · requiere autorización EXCEPCIONAL CCAA por cada tratamiento + plan aplicación Anexo VI + producto autorizado aérea (Reglamento 1107/2009) + piloto en ROPO sección fitosanitarios. **Excepción**: OCB y bioestimulantes NO sujetos al Bloque 3. **Si falla uno, ilegal aunque otros dos OK**. Implicaciones AgroM: (a) audit interno con Jonh para validar 3 bloques antes de cualquier tratamiento comercial, (b) oportunidad de producto "checklist 3 bloques" embebido en Operations type=phytosanitary, (c) contactos valiosos en el chat: Tomás (inspector ITEAF en activo, dispuesto a ayudar) + Alejandra Sandoval (UCLM/Agróptimum pistachero, autora del curso ITEAF drones). Glossary captura las 3 referencias normativas como ground truth del proyecto | 📋 Referencia 2026-06-05 |
