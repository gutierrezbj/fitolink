      ...
      <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-8 text-sm">
          ...
          <Link
            ...
            className="flex items-center gap-1.5 text-brand-700 hover:text-brand-800 transition-colors font-medium"
          >
            {/* Line-icon de insecto · simple y legible a 16px */}
            <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.7} strokeLinecap="round" strokeLinejoin="round">
              ...
              <path d="M10.5 4 L9 2.5 M13.5 4 L15 2.5" />
              <ellipse cx="12" cy="14" rx="4.5" ry="6.5" />
              <path d="M12 7.5 V20.5" />
              <path d="M7.5 11 L4 9 M7.5 14 L3.5 14 M7.5 17 L4 19" />
              <path d="M16.5 11 L20 9 M16.5 14 L20.5 14 M16.5 17 L20 19" />
            </svg>
            Visor de plagas
          </Link>
          <Link
